...
![MarkEditor logo](https://www.incasedo.cn/app/MarkEditor/imgs/128.png)

Hello there! I’m **MarkEditor**, the lightweight Markdown editor.
...
**MarkEditor** is created as a simple-to-use editor for Markdown documents. I render your Markdown contents real-time into HTML, and display them in a preview panel.

![MarkEditor Screenshot](https://www.incasedo.cn/app/MarkEditor/imgs/s1.png)
...
### Links and Email
#### Inline
Just put angle brackets around an email and it becomes clickable: <dev@incasedo.com>  
`<dev@incasedo.com>`  

Same thing with urls: <http://markeditor.incasedo.cn>  
` <http://markeditor.incasedo.cn>`  

Perhaps you want to link some text like this: [MarkEditor Website](http://markeditor.incasedo.cn "Title")  
`[MarkEditor Website](http://markeditor.incasedo.cn "Title")` (The title is optional)  
...
`[arbitrary_id]: http://markeditor.incasedo.cn "Title"`
  
If the link text itself would make a good id, you can link [like this][] `[like this][]`, then on it's own line anywhere else in the file:  
`[like this]: http://markeditor.incasedo.cn`  
...
![Markdown preferences pane](https://www.incasedo.cn/app/MarkEditor/imgs/preferences1.png)
...
![Syntax highlighting example](https://www.incasedo.cn/app/MarkEditor/imgs/highlighting.png)
...
![Rendering preferences pane](https://www.incasedo.cn/app/MarkEditor/imgs/Rendering.png)
...
![General preferences pane](https://www.incasedo.cn/app/MarkEditor/imgs/General.png)
...
![Editor preferences pane](https://www.incasedo.cn/app/MarkEditor/imgs/Editor.png)


### Styling

My editor provides syntax highlighting. You can edit the base font and the coloring/sizing theme. I provided some default themes if you don’t know where to start.
